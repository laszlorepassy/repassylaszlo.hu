...
const DICTS = {
  en: {
    ...
    speedSlowest: 'Slowest', speedSlow: 'Slow', speedNormal: 'Normal', speedFast: 'Fast', speedFastest: 'Fastest',
    ...
    submit: 'Submit',
    copyCode: 'Copy', downloadCode: 'Download',
  ...
  hu: {
    ...
    speedSlowest: 'Leglassabb', speedSlow: 'Lassú', speedNormal: 'Normál', speedFast: 'Gyors', speedFastest: 'Leggyorsabb',
    ...
    submit: 'Küldés',
    copyCode: 'Másolás', downloadCode: 'Letöltés',
