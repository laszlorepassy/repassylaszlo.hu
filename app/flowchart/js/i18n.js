...
const DICTS = {
  en: {
    ...
    menuExportCode: 'Export Source Code',
    ...
    labelNewline: 'New line after output', labelStart: 'Start', labelEnd: 'End', labelStepBy: 'Step',
  ...
  hu: {
    ...
    menuExportCode: 'Forráskód exportálása',
